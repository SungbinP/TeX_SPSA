...
\begin{minipage}{.4\textwidth}%
    \includegraphics[width=1\textwidth]{graph/GIrYkd-WYAICasH.jpg}
\end{minipage}
\end{frame}
...
\resizebox{1\textwidth}{!}{
    \includegraphics[width=.7\textwidth]{graph/GIrYkd-WYAICasH.jpg}
}
\end{frame}
...
\hyperlink{figure}{\beamerbutton{Go to figure}}
